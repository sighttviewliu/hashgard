...
`hashgardcli`: This is the command-line interface to interact with a `hashgard` full-node. 
...
::: tip
**Before you can bond atoms and withdraw rewards, you need to [set up `hashgardcli`](#setting-up-hashgardcli)**
:::
...
// ex value for flags: <validatorAddress>=gardvaloper18thamkhnj9wz8pa4nhnp9rldprgant57pk2m8s, <amountToBound>=10000000uatom, <gasPrice>=0.025uatom
...
// ex value for flags: <stcValidatorAddress>=gardvaloper18thamkhnj9wz8pa4nhnp9rldprgant57pk2m8s, <amountToRedelegate>=100000000uatom, <gasPrice>=0.025uatom
...
// ex value for flags: <validatorAddress>=gardvaloper18thamkhnj9wz8pa4nhnp9rldprgant57pk2m8s, <amountToUnbound>=10000000uatom, <gasPrice>=0.025uatom
...
hashgardcli tx gov submit-proposal --title "Test Proposal" --description "My awesome proposal" --type <type> --deposit=10000000uatom --gas auto --gas-adjustment 1.5 --gas-prices <gasPrice> --from <delegatorKeyName>
