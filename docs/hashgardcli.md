...
```bash
hashgardcli tx send ... --fees=50000uatom
```

or

```bash
hashgardcli tx send ... --gas-prices=0.025uatom
```
...
```bash
hashgardcli tx gov deposit <proposal_id> "10000000uatom" \
  --from=<name> \
  --chain-id=<chain_id>
```
...
```bash
hashgardcli tx send cosmos1570v2fq3twt0f0x02vhxpuzc9jc4yl30q2qned 1000000uatom \
